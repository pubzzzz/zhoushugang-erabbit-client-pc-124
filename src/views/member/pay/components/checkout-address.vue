  ...
  <div class="checkout-address">
    <div class="text">
      ...
      <ul v-if="showAddress">
        ...
        <li v-if="showAddress.fullLocation"><span>收货地址：</span>{{showAddress.fullLocation.replace(/ /g,'')+showAddress.address}}</li>
      </ul>
    ...
    <XtxDialog title="切换收货地址" v-model:visible="dialogVisible">
      <div
        ...
        <ul>
          ...
          <li v-if="showAddress.fullLocation"><span>收货地址：</span>{{item.fullLocation.replace(/ /g,'')+item.address}}</li>
        </ul>
      </div>
